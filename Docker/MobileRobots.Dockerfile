...
RUN echo "source /home/Mobile-Robots-Practical-Lab/turtlebot3_ws/install/setup.bash" >> /root/.bashrc
RUN echo "source /home/Mobile-Robots-Practical-Lab/my_ws/install/setup.bash" >> /root/.bashrc

WORKDIR /home/Mobile-Robots-Practical-Lab